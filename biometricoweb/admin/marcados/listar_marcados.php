    ...
    <header>
        <div align="center">
            ...
            <form class="form-signin" action="index.php" method="POST">
                ...
                <button id="excel" name="excel" class="btn btn-lg btn-success btn-block" type="submit">Generar Excel</button>
                    ...
                    <table id="customers">
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <img src="../../<?php echo $row['fotos']; ?>" class="img-rounded" width="64px" height="64px" /> </td>

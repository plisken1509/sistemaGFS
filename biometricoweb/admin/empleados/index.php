...
<body style="background-color:#9b9b9a;">
    ...
    <header>
        <div align="center">
            ...
            ?>
                ...
                ?>
                    <div style="background-color:#8D5B35;" class="alert fade in">
                        <div style="text-align:center;color:yellow;font-weight:900">
                            <?php echo "Registro de empleado eliminado!"; ?> !
                        </div>
                    <?php
                }
                    ?>
                                    ...
                                    <tbody style="background-color:white;">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td> <a href="consultar_marcados.php?cedula=<?php echo $row["cedula"]; ?>" title="Consultar Personal"> <img style="width:32px" src="../img/marcados.png" /></a></td>
                                                <td> <a href="editar.php?cedula=<?php echo $row["cedula"]; ?>" title="Editar Personal"> <img style="width:32px" src="img/editar.png" /></a></td>
                                                <td> <a href="codigo_eliminar.php?cedula=<?php echo $row["cedula"]; ?>" title="Eliminar Personal" onclick="return confirmar()"> <img style="width:32px" src="img/delete.png" /></a></td>
    ...
    <script>
        function confirmar() {
          var respuesta = confirm("¿Desea eliminar este empleado?");
          if (respuesta == true) {
            return true;
          } else {
            return false;
